import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'file:///Users/mr.xuww/Documents/project/project-ssr-nuxt/node_modules/.pnpm/vue@3.5.5_typescript@5.6.2/node_modules/vue/index.mjs';
import { c as useNuxtApp, d as asyncDataDefaults, e as createError, b as useRuntimeConfig, g as withLeadingSlash, j as joinURL, a as withoutTrailingSlash, f as withBase } from './server.mjs';
import { a as useRequestEvent, h as hash, u as useContentPreview } from './preview-T-XJfdts.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-Cm3KlgwB.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DDQGdMEp.mjs.map
